...
\vspace{-0.1in}
\begin{center}
\includegraphics[width=\linewidth]{./Figs21/Png/desc_minus_asc_5pc_hot_bt_trend_with_airs_v7.png}
\end{center}
\end{block}
\end{column}
...
\vspace{-0.05in}
\begin{center}
\includegraphics[width=\linewidth]{./Figs21/Pdf/pro_tsurf_anom.pdf}
\end{center}
\end{block}
\end{column}
\end{columns}
...
\vspace{-0.1in}
\begin{center}
\includegraphics[width=\linewidth]{./Figs21/Pdf/global_trends_hottest3pc_and)allsky.pdf}
\end{center}
\end{block}
\end{column}
...
\vspace{-0.05in}
\begin{center}
\includegraphics[width=\linewidth]{./Figs21/Pdf/global_bt1231_anomaly.pdf}
\end{center}
\end{block}
\end{column}
\end{columns}
