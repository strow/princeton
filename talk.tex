...
%---------------------------------------------------------------------------------------------
%x%x% \begin{frame}
%x%x% \frametitle{Measured BT Spectra and Trends for Clear Scenes}  
%x%x% \vspace{-0.03in}
%x%x% \centering \includegraphics[width=0.7\linewidth]{Figslls/bt_trends_all_cm.png}
%x%x% \vspace{-0.05in}
%x%x% \begin{small}
%x%x% \begin{itemize}
%x%x% \item Same as previous slide but in BT units.
%x%x% \item AIRS etc. covers same altitudes that control far-IR emission
%x%x% \item Highlights water vapor feedback, lowering emission to space
%x%x% \item Note: Tropospheric warming close to surface temperature warming  
%x%x% \end{itemize}
%x%x% \end{small}
%x%x% \end{frame}
%---------------------------------------------------------------------------------------------
%x%x% \begin{frame}
%x%x%   \frametitle{Upwelling Radiance Example}
%x%x% \vspace{-0.05in}
%x%x%   \centering \includegraphics[width=0.625\linewidth]{Figslls/mono1460.pdf}
%x%x% \vspace{-0.05in}
%x%x% \begin{small}
%x%x% \begin{itemize}
%x%x%   \item Line centers 
%x%x%      \begin{itemize}
%x%x%         \item have stratospheric contributions \vspace{-0.03in}
%x%x%         \item A further zoom will show a dip from the mesosphere at line centers!
%x%x%         \item SRF convolution $\rightarrow$ broad weighting function
%x%x%     \end{itemize}
%x%x%   \item \textcolor{red}{Best sounding channels are in-between lines $\rightarrow$ narrow weighting function} (pressure$^2$ dependence)
%x%x%   \end{itemize}
%x%x% \end{small}
%x%x% \end{frame}
%x%x% % ---------------------------------------------------------------------------------------------
...
%% AIRS sounder has most sensitivity to mid tropospheric WV
\vspace{-0.35in}
\begin{center}
...
%---------------------------------------------------------------------------------------------
%x%x% \begin{frame}
%x%x% \frametitle{Surface Temperature Trend Comparisons 2002/09-2014/08}  
%x%x% \vspace{-0.15in}
%x%x% \begin{center}
%x%x% \includegraphics[width=0.9\linewidth]{Figs2002_2014/stemp_trends_2002_2014_amip6.png}
%x%x% \end{center}
%x%x% 
%x%x% \footnotesize
%x%x% GISS trends very similar to eg ERA5, MERRA2
%x%x% 
%x%x% \end{frame}
%x%x% %---------------------------------------------------------------------------------------------
%x%x% \begin{frame}
%x%x% \frametitle{Zonal T(z) Trends 2002/09-2014/08}  
%x%x% \vspace{-0.15in}
%x%x% \begin{center}
%x%x% \includegraphics[width=0.8\linewidth]{Figs2002_2014/tz_trends_2002_2014.pdf}
%x%x% \end{center}
%x%x% 
%x%x% \footnotesize
%x%x% IR has null space near tropopause.  But trends correctly change sign there.\\
%x%x% \vspace{0.1in}
%x%x% UMBC uncertainties \textasciitilde{}0.01K/year (inter-annual variability)
%x%x% 
%x%x% \end{frame}
%x%x% %---------------------------------------------------------------------------------------------

\begin{frame}
\frametitle{\textcolor{red}{Trends 2002/09-2014/08}}  
...
%\frametitle{\textcolor{red}{WV fractional Trends 2002/09-2014/08}}  
%\begin{center}
...
%x%x% %---------------------------------------------------------------------------------------------
%x%x% \begin{frame}
%x%x% \frametitle{RH(z) Trends 2002/09-2014/08}  
%x%x% \vspace{-0.15in}
%x%x% \begin{center}
%x%x% \includegraphics[width=0.8\textwidth]{Figs2002_2014/RHz_trends_2002_2014.pdf}
%x%x% \end{center}
%x%x% 
%x%x% \small
%x%x% \begin{itemize}
%x%x% \item MLS water vapor unimportant for OLR applications
%x%x% \item Mean global \(\Delta\) RH < 0.01\%/year
%x%x% \end{itemize}
%x%x% 
%x%x% \end{frame}
%x%x% %---------------------------------------------------------------------------------------------
